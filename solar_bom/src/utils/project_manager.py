...
class ProjectManager:
    ...
    def copy_project(self, original_filepath: str, new_name: str) -> bool:
        """
        Copy an existing project with a new name
        
        Args:
            original_filepath: Path to the original project file
