...
class ProjectInfoTab(ttk.Frame):
    ...
    def setup_ui(self):
        ...
        quick_estimate_btn = ttk.Button(
            tools_frame, 
            text="Quick Estimate", 
            command=self.open_quick_estimate,
            width=20
        )
        quick_estimate_btn.pack(side='left', padx=5, pady=5)
    ...
    def open_quick_estimate(self):
        ...
        dialog = QuickEstimateDialog(self.winfo_toplevel(), self.current_project)
        # Dialog is modal, will wait until closed
